...
/**
 * ArrayHopper Class to Find the Minimum Jumps
 * @author Yan Li
 */
public class ArrayHopper {
	public static final String HOP_FAILURE = "failure";
	public static final String HOP_OUT = "out";
	private static final Logger LOGGER = Logger.getLogger(ArrayHopper.class.getName());
	...
	public static void main(String[] args) {
		...
		switch (args.length) {
			case NUMBER_OF_VALID_ARGUMENTS:
				ArrayHopper arrayHopperObject = new ArrayHopper();
